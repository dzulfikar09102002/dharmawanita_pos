...
import Modal, { ModalState } from '@/components/payment-method/modal';
import Alert, { AlertState } from '@/components/payment-method/alert';
...
const columns: ColumnDef<PaymentMethod, any>[] = [
    {
        id: 'no',
        header: 'No',
    ...
    }),
    {
        ...
        header: 'Aksi',
        cell: (info) => {
            const pmethod = info.row.original as PaymentMethod & { id: number };
...
export default ({ pagination }: Props) => {
    ...
    const table = useReactTable<PaymentMethod>({
        data,
        columns,
